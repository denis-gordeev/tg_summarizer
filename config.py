...
COVERAGE_CHECK_MAX_SUMMARIES = _get_int_env("COVERAGE_CHECK_MAX_SUMMARIES", 10)
COVERAGE_CHECK_MAX_CHARS_PER_SUMMARY = _get_int_env("COVERAGE_CHECK_MAX_CHARS_PER_SUMMARY", 300)
