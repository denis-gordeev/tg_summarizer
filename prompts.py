...
- AI/BigTech новости (OpenAI, Anthropic, Google, Meta, Microsoft, Nvidia, DeepMind и т.д.)
- AI-ассистенты (ChatGPT, Claude, Gemini, Grok, DeepSeek, Midjourney и т.д.)
- LLM, промпт-инжиниринг, обучение/дообучение (LoRA и др.), vibe coding, AI-агенты
- Диффузия, GPU, робототехника, стартапы, M&A
- AI-мемы, новые детали уже вышедших моделей/библиотек
...
Структурируй по темам, указывай номера источников [1], [2]; при совпадении темы — все номера. Кратко описывай архитектуру, методологию, результаты.

Правила:
- Без введения и заключения — сразу с содержания
- Нейтральный стиль: без эмоций, преувеличений и дословных рекомендаций авторов
- Заголовки: короткие, яркие, с 1–3 несинонимичных эмодзи. Пример: '<b>🧠💧 Переходы между AI-компаниями</b>'
